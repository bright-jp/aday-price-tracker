"""
Aday Price Tracker - Bright Data Web Scraper API
----------------------------------------------------
Track prices, availability, and product data from Aday.

Docs  : https://docs.brightdata.jp/scraping-automation/web-scraper-api/overview
Info  : https://brightdata.jp/products/insights/price-tracker/aday
"""
...
# Set your Web Scraper ID after building your Aday scraper:
# https://brightdata.jp/products/web-scraper/aday
DATASET_ID = os.getenv("BRIGHTDATA_DATASET_ID", "")
if not DATASET_ID:
    raise EnvironmentError(
        "BRIGHTDATA_DATASET_ID is not set.\n"
        "1. Build your Aday scraper at: https://brightdata.jp/products/web-scraper/aday\n"
...
def track_prices(urls: list[str], **kwargs) -> list[dict]:
    """
    Collect price data for a list of Aday product URLs.
...
def discover_by_keyword(keyword: str, limit: int = 50, **kwargs) -> list[dict]:
    """
    Discover Aday products by keyword search.
...
def discover_by_category(category_url: str, limit: int = 100, **kwargs) -> list[dict]:
    """
    Discover all products from a Aday category page.

    Example:
        results = discover_by_category("https://aday.com/s?k=headphones", limit=200)
    """
...
if __name__ == "__main__":
    ...
    sample_urls = [
        "https://www.aday.com/product/sample-item-123456",
        # Add more Aday product URLs here
    ]
    results = track_prices(sample_urls)

    output_file = "aday_prices.json"
    ...
    # cat_results = discover_by_category("https://aday.com/category/sample", limit=50)
